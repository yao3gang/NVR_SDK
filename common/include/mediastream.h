...
//#define RS_ENABLE			//csp add 2008-12-01
...
#define LOOP_BUF_UINT_NUM			(INT32)400//200//400
...
#define DEFAULT_RSND_TIME_SPAN		(u16)1000//1秒
#define MIN_RS_UNIT_NUM				(u16)100 //
#define MAX_RS_UNIT_NUM				(u16)3000//

typedef struct TimeSet				//06-11 跟时间相关的参数定义
{
	int grabIntervalTime;
	int nNumOfPacket;
}TimeSet;
...
//发送数据包
u16 SendMediaFrame(ifly_mediasnd_t* pMediaSnd,PFRAMEHDR pFrmHdr,int avgInterTime);	//06-11
