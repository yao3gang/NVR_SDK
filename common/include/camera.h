...
#define CAM_TYPE_WV_CS850				4
#define CAM_TYPE_WV_CS650				5
...
#define MAX_CRUISEPATH_NUM				16//cruisepath limit 0-MAX_CRUISEPATH_NUM
#define MAX_CRUISEPOS_NUM				16//cruisepos limit 0-MAX_CRUISEPOS_NUM
#define MAX_CRUISE_SPEED				9//cruise speed 0-MAX_CRUISE_SPEED

#define MAX_PROTOCOL_LEN				64//协议的最大长度
#define MAX_PARAM_NUM					8//最大参数个数
